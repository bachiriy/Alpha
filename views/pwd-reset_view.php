...
<div class="h-screen md:flex">
    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form class="bg-white" action="index.php?page=login" method="post">
            ...
            <button type="submit" name="login_btn" class="hover:opacity-90 block w-full bg-red-700 bg-gradient-to-r from-indigo-700 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Reset Password</button>
