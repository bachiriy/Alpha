    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form class="bg-white" method="post" action="index.php?page=register">
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                ...
                <input class="pl-2 outline-none border-none" type="email" name="email" id="" placeholder="Enter your Gmail" />
            </div>
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                ...
                <label for=""></label><input class="pl-2 outline-none border-none" type="password" name="password" id="" placeholder="Password" />
            </div>
